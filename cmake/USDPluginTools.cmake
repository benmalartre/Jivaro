...
function(_usd_target_properties
    ...
    set(_INCLUDE_DIRS "")
    list(APPEND _INCLUDE_DIRS ${args_INCLUDE_DIRS} ${USD_INCLUDE_DIR} ${TBB_INCLUDE_DIR})
    #if (ENABLE_PYTHON_SUPPORT)
    #    list(APPEND _INCLUDE_DIRS ${Python3_INCLUDE_DIRS} ${Boost_INCLUDE_DIR})
    #endif()
    target_include_directories(${TARGET_NAME}
        SYSTEM
        PRIVATE
    ...
    # Link to libraries.
    set(_LINK_LIBRARIES "")
    list(APPEND _LINK_LIBRARIES ${args_LIBRARIES} ${USD_LIBRARIES} ${TBB_LIBRARIES})
    #if (ENABLE_PYTHON_SUPPORT)
...
function(_usd_set_test_properties
    ...
    if (USE_PYTHONPATH)
        ...
        list(APPEND TEST_PYTHON_PATH 
            ...
            "${USD_DIR}/${CMAKE_INSTALL_LIBDIR}/python"
        )
    ...
    if (MSVC)
        ...
        list(APPEND TEST_PATH 
            ...
            "${USD_DIR}/${CMAKE_INSTALL_LIBDIR}"
            "${USD_DIR}/${CMAKE_INSTALL_BINDIR}"
        )
