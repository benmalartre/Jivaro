...
bool Grid3DIntersector::Raycast(const pxr::GfVec3f* points, const pxr::GfRay& ray, Location* hit,
...
bool Grid3DIntersector::Closest(const pxr::GfVec3f* points, const pxr::GfVec3f& point, Location* hit,
