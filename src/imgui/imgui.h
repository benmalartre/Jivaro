...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_AllowItemOverlap     = 1 << 2,   // Locationtesting to allow subsequent widgets to overlap this one
...
enum ImGuiSelectableFlags_
{
    ...
    ImGuiSelectableFlags_AllowItemOverlap   = 1 << 4,   // (WIP) Locationtesting to allow subsequent widgets to overlap this one
};
