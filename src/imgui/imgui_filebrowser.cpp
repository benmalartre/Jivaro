...
namespace ImGui
{
    ...
    void FileBrowser::clearFileList()
    {
    ...
    bool FileBrowser::showFileDialog(const std::string& label, const DialogMode mode, const ImVec2& sz_xy, const std::string& valid_types)
    {
    ...
    bool FileBrowser::renderNavAndSearchBarRegion()
    {
    ...
    bool FileBrowser::renderFileListRegion()
    {
        ImGuiStyle& style = ImGui::GetStyle();
    ...
    bool FileBrowser::renderInputTextAndExtRegion()
    {
    ...
    bool FileBrowser::renderButtonsAndCheckboxRegion()
    {
        ImVec2 pw_size = ImGui::GetWindowSize();
        ImGuiStyle& style = ImGui::GetStyle();
        bool show_error = false;
    ...
    bool FileBrowser::renderInputComboBox()
    {
        bool show_error = false;
        ImGuiStyle& style = ImGui::GetStyle();
    ...
    bool FileBrowser::onNavigationButtonClick(int idx)
    {
        std::string new_path = "";
    ...
    bool FileBrowser::onDirClick(int idx)
    {
        std::string name;
    ...
    bool FileBrowser::readDIR(std::string pathdir)
    {
        DIR* dir;
        struct dirent *ent;
    ...
    void FileBrowser::filterFiles(int filter_mode)
    {
        filter_dirty = false;
    ...
    void FileBrowser::showHelpMarker(std::string desc)
    {
        ImGui::TextDisabled("(?)");
    ...
    void FileBrowser::showErrorModal()
    {
    ...
    bool FileBrowser::showReplaceFileModal()
    {
    ...
    void FileBrowser::showInvalidFileModal()
    {
        ImGuiStyle& style = ImGui::GetStyle();
    ...
    void FileBrowser::setValidExtTypes(const std::string& valid_types_string)
    {
    ...
    ImVec2 FileBrowser::getButtonSize(std::string button_text)
    {
        return (ImGui::CalcTextSize(button_text.c_str()) + ImGui::GetStyle().FramePadding * 2.0);
    }

    void FileBrowser::parsePathTabs(std::string path)
    {
    ...
    std::string FileBrowser::wStringToString(const wchar_t* wchar_arr)
    {
    ...
    bool FileBrowser::alphaSortComparator(const Info& a, const Info& b)
    {
    ...
    #ifdef OSWIN
    bool FileBrowser::loadWindowsDrives()
    {
    ...
    //Unix only
    #ifndef OSWIN
    void FileBrowser::initCurrentPath()
    {
