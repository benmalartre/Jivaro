...
static ImVec4 SELECTED_COLOR(0.9f, 0.9f, 0.9f, 1.f);
...
static ImVec4 BUTTON_COLOR(0.25f, 0.25f, 0.25f, 1.f);
static ImVec4 BUTTON_HOVERED_COLOR(0.33f, 0.33f, 0.33f, 1.f);
