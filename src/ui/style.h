#ifndef JVR_UI_STYLE_H
#define JVR_UI_STYLE_H
...
static void SetStyle(ImGuiStyle* dst)
{
  ...
  style->FramePadding = pxr::GfVec2f(2.f, 2.f);
  style->ChildBorderSize = 0.f;
  style->FrameBorderSize = 0.f;
  style->IndentSpacing = 8.f;
  style->ItemSpacing = pxr::GfVec2f(4.f,2.f);
  style->ItemInnerSpacing = pxr::GfVec2f(4.f, 0.f);
  ...
  colors[ImGuiCol_PopupBg] = ImVec4(0.95f, 0.35f, 0.35f, 1.0f);
  ...
  colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.65f, 0.65f, 0.65f, 0.32f);
