...
/*
  ...
  */
  ...
  virtual pxr::GfVec3f ResolveContact(Particles* particles, size_t index, const float dt) = 0;
...
public:
  ...
  pxr::GfVec3f ResolveContact(Particles* particles, size_t index, const float dt) override;
