...
namespace PBD {
  size_t Body::AddGeometry(PBD::_Geometry* geom)
  {
  ...
  void Body::RemoveGeometry(PBD::_Geometry* geom)
  {
  ...
  void Body::Reset(size_t start, size_t end)
  {
  ...
  void Body::Integrate(size_t start, size_t end, float step)
  {
  ...
  void Body::AccumulateForces(size_t start, size_t end, const pxr::GfVec3f& gravity)
  {
