...
{
  std::cout << "Mesh Collision Initialize..." << std::endl;
  _query.resize(numParticles, Location());
  std::cout << "num queries : " << _query.size() << std::endl;
}
